...
if(isset($_POST["e_user"])) {
    $e_user = $_POST["e_user"];
    $_SESSION["e_user"] = $e_user;
} elseif(isset($_SESSION["e_user"])) {
...
if(!empty($e_user)) {
    ...
    header("location: allEmployer.php");
    exit();
}
...
<!--Main profile card-->
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			<div class="card-body text-center">
				<img src="<?php echo $profile_image; ?>" class="img-fluid rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;">
				<h2><?php echo $name; ?></h2>
