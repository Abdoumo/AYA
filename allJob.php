...
<!--Freelancer Profile Details-->	
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			<div class="panel panel-success">
			  <div class="panel-heading"><h3>Toutes les Offres</h3></div>
		...
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			...
			<form action="allJob.php" method="post">
				<div class="form-group">
				  ...
				  <center><button type="submit" class="btn btn-info">Rechercher par titre</button></center>
				</div>
	        </form>
	        ...
	        <form action="allJob.php" method="post">
				<div class="form-group">
				  ...
				  <center><button type="submit" class="btn btn-info">Rechercher par type</button></center>
				</div>
	        </form>
	        ...
	        <form action="allJob.php" method="post">
				<div class="form-group">
				  ...
				  <center><button type="submit" class="btn btn-info">Rechercher par employeur</button></center>
				</div>
	        </form>
	        ...
	        <form action="allJob.php" method="post">
				<div class="form-group">
				  ...
				  <center><button type="submit" class="btn btn-info">Rechercher par ID</button></center>
				</div>
	        </form>

	        <form action="allJob.php" method="post">
				<div class="form-group">
				  <center><button type="submit" name="recentJob" class="btn btn-warning">Voir les offres récentes</button></center>
				</div>
	        </form>

	        <form action="allJob.php" method="post">
				<div class="form-group">
				  <center><button type="submit" name="oldJob" class="btn btn-warning">Voir les offres plus anciennes</button></center>
				</div>
	        </form>
